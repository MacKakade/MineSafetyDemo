 ...
 * {@link com.dmi.minesafety.demo.fragment.DocumentListFragment} and the item details (if present) is a {@link
 * com.dmi.minesafety.demo.fragment.DocumentDetailFragment}. <p> This activity also implements the required
 * {@link com.dmi.minesafety.demo.fragment.DocumentListFragment.Callbacks} interface to listen for item
 * selections.
 */
